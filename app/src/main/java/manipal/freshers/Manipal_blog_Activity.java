...
@SuppressLint("NewApi") public class Manipal_blog_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://manipalblog.com/");
...
*/
        ...
        b4.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Manipal_blog_Activity.this, MIT_Sports_Club_Activity.class);
                                      startActivity(i);
        ...
        b6.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Manipal_blog_Activity.this,MUTC_Activity.class);
                                      startActivity(i);
        ...
        b8.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Manipal_blog_Activity.this, SIS_Activity.class);
                                      startActivity(i);
