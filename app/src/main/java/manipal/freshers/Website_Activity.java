...
public class Website_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://manipal.edu/mu.html");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      Intent i = new Intent(Website_Activity.this, MainActivity.class);
                                      startActivity(i);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this, Manipal_blog_Activity.class);
                                      startActivity(i);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this, MitFiles_Activity.class);
                                      startActivity(i);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this, MIT_Sports_Club_Activity.class);
                                      startActivity(i);
        ...
        b5.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this, MTTN_Activity.class);
                                      startActivity(i);
        ...
        b6.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this,MUTC_Activity.class);
                                      startActivity(i);
        ...
        b7.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this, Revels_Activity.class);
                                      startActivity(i);
        ...
        b8.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this, SIS_Activity.class);
                                      startActivity(i);
        ...
        b9.setOnClickListener(new View.OnClickListener() {
                                  ...
                                  public void onClick(View v) {
                                      ...
                                      Intent i = new Intent(Website_Activity.this, Student_council_Activity.class);
                                      startActivity(i);
        ...
        b10.setOnClickListener(new View.OnClickListener() {
                                   ...
                                   public void onClick(View v) {
                                       ...
                                       Intent i = new Intent(Website_Activity.this, Techtatva_Activity.class);
                                       startActivity(i);
        ...
        b11.setOnClickListener(new View.OnClickListener() {
                                   ...
                                   public void onClick(View v) {
                                       ...
                                       Intent i = new Intent(Website_Activity.this,Websis_Activity.class);
                                       startActivity(i);
